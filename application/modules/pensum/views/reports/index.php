...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Pensum.Reports.Delete');
$can_edit		= $this->auth->has_permission('Pensum.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/pensum/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->codigo_pensum); ?></td>
				<?php else : ?>
