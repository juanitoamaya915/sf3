...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Pensum.Developer.Delete');
$can_edit		= $this->auth->has_permission('Pensum.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/pensum/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->codigo_pensum); ?></td>
				<?php else : ?>
