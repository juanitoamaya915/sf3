...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Pensum.Content.Delete');
$can_edit		= $this->auth->has_permission('Pensum.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/pensum/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->codigo_pensum); ?></td>
				<?php else : ?>
