...
{
    protected $permissionCreate = 'Pensum.Settings.Create';
    protected $permissionDelete = 'Pensum.Settings.Delete';
    protected $permissionEdit   = 'Pensum.Settings.Edit';
    protected $permissionView   = 'Pensum.Settings.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_pensum()) {
				...
				redirect(SITE_AREA . '/settings/pensum');
			}
