...
{
    protected $permissionCreate = 'Pensum.Content.Create';
    protected $permissionDelete = 'Pensum.Content.Delete';
    protected $permissionEdit   = 'Pensum.Content.Edit';
    protected $permissionView   = 'Pensum.Content.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_pensum()) {
				...
				redirect(SITE_AREA . '/content/pensum');
			}
