...
{
    protected $permissionCreate = 'Pensum.Developer.Create';
    protected $permissionDelete = 'Pensum.Developer.Delete';
    protected $permissionEdit   = 'Pensum.Developer.Edit';
    protected $permissionView   = 'Pensum.Developer.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_pensum()) {
				...
				redirect(SITE_AREA . '/developer/pensum');
			}
