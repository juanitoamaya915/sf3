...
{
    protected $permissionCreate = 'Estudiante.Developer.Create';
    protected $permissionDelete = 'Estudiante.Developer.Delete';
    protected $permissionEdit   = 'Estudiante.Developer.Edit';
    protected $permissionView   = 'Estudiante.Developer.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_estudiante()) {
				...
				redirect(SITE_AREA . '/developer/estudiante');
			}
