...
{
    protected $permissionCreate = 'Estudiante.Content.Create';
    protected $permissionDelete = 'Estudiante.Content.Delete';
    protected $permissionEdit   = 'Estudiante.Content.Edit';
    protected $permissionView   = 'Estudiante.Content.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_estudiante()) {
				...
				redirect(SITE_AREA . '/content/estudiante');
			}
