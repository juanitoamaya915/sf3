...
{
    protected $permissionCreate = 'Estudiante.Reports.Create';
    protected $permissionDelete = 'Estudiante.Reports.Delete';
    protected $permissionEdit   = 'Estudiante.Reports.Edit';
    protected $permissionView   = 'Estudiante.Reports.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_estudiante()) {
				...
				redirect(SITE_AREA . '/reports/estudiante');
			}
