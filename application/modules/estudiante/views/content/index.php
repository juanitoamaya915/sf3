...
$num_columns	= 9;
$can_delete	= $this->auth->has_permission('Estudiante.Content.Delete');
$can_edit		= $this->auth->has_permission('Estudiante.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/estudiante/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->codigo_estudiante); ?></td>
				<?php else : ?>
