...
<div class='admin-box'>
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		...
		<fieldset class='form-actions'>
			...
			<?php echo lang('bf_or'); ?>
			<?php echo anchor(SITE_AREA . '/reports/carreras_universitarias', lang('carreras_universitarias_cancel'), 'class="btn btn-warning"'); ?>
			
			<?php if ($this->auth->has_permission('Carreras_Universitarias.Reports.Delete')) : ?>
				<?php echo lang('bf_or'); ?>
