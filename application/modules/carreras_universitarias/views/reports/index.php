...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Carreras_Universitarias.Reports.Delete');
$can_edit		= $this->auth->has_permission('Carreras_Universitarias.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/carreras_universitarias/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->id_carrera); ?></td>
				<?php else : ?>
