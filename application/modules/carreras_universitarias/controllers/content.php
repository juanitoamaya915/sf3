...
{
    protected $permissionCreate = 'Carreras_universitarias.Content.Create';
    protected $permissionDelete = 'Carreras_universitarias.Content.Delete';
    protected $permissionEdit   = 'Carreras_universitarias.Content.Edit';
    protected $permissionView   = 'Carreras_universitarias.Content.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_carreras_universitarias()) {
				...
				redirect(SITE_AREA . '/content/carreras_universitarias');
			}
