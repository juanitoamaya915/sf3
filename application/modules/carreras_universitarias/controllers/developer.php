...
{
    protected $permissionCreate = 'Carreras_universitarias.Developer.Create';
    protected $permissionDelete = 'Carreras_universitarias.Developer.Delete';
    protected $permissionEdit   = 'Carreras_universitarias.Developer.Edit';
    protected $permissionView   = 'Carreras_universitarias.Developer.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_carreras_universitarias()) {
				...
				redirect(SITE_AREA . '/developer/carreras_universitarias');
			}
