...
{
    protected $permissionCreate = 'Carreras_universitarias.Reports.Create';
    protected $permissionDelete = 'Carreras_universitarias.Reports.Delete';
    protected $permissionEdit   = 'Carreras_universitarias.Reports.Edit';
    protected $permissionView   = 'Carreras_universitarias.Reports.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_carreras_universitarias()) {
				...
				redirect(SITE_AREA . '/reports/carreras_universitarias');
			}
