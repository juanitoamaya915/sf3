...
{
    protected $permissionCreate = 'Tutor.Content.Create';
    protected $permissionDelete = 'Tutor.Content.Delete';
    protected $permissionEdit   = 'Tutor.Content.Edit';
    protected $permissionView   = 'Tutor.Content.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_tutor()) {
				...
				redirect(SITE_AREA . '/content/tutor');
			}
