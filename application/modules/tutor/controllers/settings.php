...
{
    protected $permissionCreate = 'Tutor.Settings.Create';
    protected $permissionDelete = 'Tutor.Settings.Delete';
    protected $permissionEdit   = 'Tutor.Settings.Edit';
    protected $permissionView   = 'Tutor.Settings.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_tutor()) {
				...
				redirect(SITE_AREA . '/settings/tutor');
			}
