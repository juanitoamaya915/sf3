...
{
    protected $permissionCreate = 'Tutor.Developer.Create';
    protected $permissionDelete = 'Tutor.Developer.Delete';
    protected $permissionEdit   = 'Tutor.Developer.Edit';
    protected $permissionView   = 'Tutor.Developer.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_tutor()) {
				...
				redirect(SITE_AREA . '/developer/tutor');
			}
