...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Tutor.Developer.Delete');
$can_edit		= $this->auth->has_permission('Tutor.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/tutor/edit/' . $record->id_tutor, '<span class="icon-pencil"></span> ' .  $record->nombre_tutor); ?></td>
				<?php else : ?>
