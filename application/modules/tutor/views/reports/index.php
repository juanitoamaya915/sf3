...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Tutor.Reports.Delete');
$can_edit		= $this->auth->has_permission('Tutor.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/tutor/edit/' . $record->id_tutor, '<span class="icon-pencil"></span> ' .  $record->nombre_tutor); ?></td>
				<?php else : ?>
