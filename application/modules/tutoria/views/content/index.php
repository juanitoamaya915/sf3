...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('Tutoria.Content.Delete');
$can_edit		= $this->auth->has_permission('Tutoria.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/tutoria/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->cadigo_tutoria); ?></td>
				<?php else : ?>
