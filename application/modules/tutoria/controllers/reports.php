...
{
    protected $permissionCreate = 'Tutoria.Reports.Create';
    protected $permissionDelete = 'Tutoria.Reports.Delete';
    protected $permissionEdit   = 'Tutoria.Reports.Edit';
    protected $permissionView   = 'Tutoria.Reports.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_tutoria()) {
				...
				redirect(SITE_AREA . '/reports/tutoria');
			}
