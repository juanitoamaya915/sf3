...
{
    protected $permissionCreate = 'Tutoria.Content.Create';
    protected $permissionDelete = 'Tutoria.Content.Delete';
    protected $permissionEdit   = 'Tutoria.Content.Edit';
    protected $permissionView   = 'Tutoria.Content.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_tutoria()) {
				...
				redirect(SITE_AREA . '/content/tutoria');
			}
