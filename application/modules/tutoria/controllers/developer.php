...
{
    protected $permissionCreate = 'Tutoria.Developer.Create';
    protected $permissionDelete = 'Tutoria.Developer.Delete';
    protected $permissionEdit   = 'Tutoria.Developer.Edit';
    protected $permissionView   = 'Tutoria.Developer.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_tutoria()) {
				...
				redirect(SITE_AREA . '/developer/tutoria');
			}
