...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Cliente.Content.Delete');
$can_edit		= $this->auth->has_permission('Cliente.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/cliente/edit/' . $record->id_cliente, '<span class="icon-pencil"></span> ' .  $record->nombre); ?></td>
				<?php else : ?>
