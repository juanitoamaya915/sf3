...
{
    protected $permissionCreate = 'Cliente.Reports.Create';
    protected $permissionDelete = 'Cliente.Reports.Delete';
    protected $permissionEdit   = 'Cliente.Reports.Edit';
    protected $permissionView   = 'Cliente.Reports.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_cliente()) {
				...
				redirect(SITE_AREA . '/reports/cliente');
			}
