...
{
    protected $permissionCreate = 'Cliente.Content.Create';
    protected $permissionDelete = 'Cliente.Content.Delete';
    protected $permissionEdit   = 'Cliente.Content.Edit';
    protected $permissionView   = 'Cliente.Content.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_cliente()) {
				...
				redirect(SITE_AREA . '/content/cliente');
			}
