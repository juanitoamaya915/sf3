...
{
    protected $permissionCreate = 'Cliente.Settings.Create';
    protected $permissionDelete = 'Cliente.Settings.Delete';
    protected $permissionEdit   = 'Cliente.Settings.Edit';
    protected $permissionView   = 'Cliente.Settings.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_cliente()) {
				...
				redirect(SITE_AREA . '/settings/cliente');
			}
